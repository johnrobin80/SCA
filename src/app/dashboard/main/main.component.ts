...
@Component({
  ...
  imports: [RouterLink, NgbProgressbar, NgApexchartsModule, NgScrollbar],
})
export class MainComponent implements OnInit {
  ...
  private chart1() {
    this.lineChartOptions = {
      series: [
        {
          name: 'OnTime',
          data: [20, 35, 30, 23, 28, 19, 17, 24, 35, 20],
        },
        {
          name: 'Rescheduled',
          data: [4, 9, 13, 6, 3, 6, 9, 5, 10, 5],
        },
      ],
      chart: {
        height: 350,
  ...
  generatePDF() {
    /*const elementToDownload: any = document.getElementById(
      'divSupplierScoreCard'
    );
    html2canvas(elementToDownload, { scale: 2 }).then((canvas) => {
      ...
      pdf.setProperties({
        title: 'ScoreCardPdf',
        subject: 'Supplier Score Card',
        author: 'Admin-SupplyChain',
      });
      pdf.setFontSize(12);
      //pdf.text('Supplier score card', 14, 22);
      pdf.save('RDI-SupplierScoreCard.pdf');
    });*/
